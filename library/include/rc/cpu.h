 ...
 *
 *             Functions to read and set the current CPU scaling function. This
 *             is not specific to the beaglebone and should work on any linux
 *             system, however since the beaglebone has a single cpu core, this
 *             only changes the govenor for one core.
 *
 ...
 *
 *             This is the equivalent to running 'cpufreq-set -g {governor}'
 *             from the command line but can be called in your C program
 *             instead.
 *
 ...
 *             processor in the form of the provided enumerated type. It will
 *             never return the FREQ_ONDEMAND value as the intention of this
 *             function is to see the clock speed as set by either the user or
 *             the ondemand governor itself.
 *
