...
File Structure:
project_name.c	- This is your main source file
Makefile        - You must update the first line of this with your new project name for make to recognize the new .c file.
...
make - Links and compiles your source file into a local executable. Run with "./project_name" in the project folder.
