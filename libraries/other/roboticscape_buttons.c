...
void (*pause_pressed_func)(void)	= &null_func;
void (*pause_released_func)(void)	= &null_func;
void (*mode_pressed_func)(void)		= &null_func;
void (*mode_released_func)(void)	= &null_func;
