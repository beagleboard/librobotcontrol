...
const char* pwm_unexport_path[3] = { \
...
const char* pwm_chA_enable_path[3] = { \
...
const char* pwm_chB_enable_path[3] = { \
...
const char* pwm_chA_polarity_path[3] = { \
...
const char* pwm_chB_polarity_path[3] = { \
...
const char* pwm_chA_period_path[3] = { \
...
const char* pwm_chB_period_path[3] = { \
...
const char* pwm_chA_duty_path[3] = { \
...
const char* pwm_chB_duty_path[3] = { \
